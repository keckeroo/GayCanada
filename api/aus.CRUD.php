...
$MYSQL_TABLE      = "cglbrd.AUS";
$MYSQL_RECORDKEY  = "Tracking_Number";
$MYSQL_ORDERFIELD = "Tracking_Number";
$MYSQL_CMD        = 'pending';
...
$cmd          = $_REQUEST['cmd'] ? $_REQUEST['cmd'] : $MYSQL_CMD;
...
$whereClause = "1 = 0"; // force failure in case no parameters are specified
...
//if ($REMOTE_ACCOUNT) {
   switch ($cmd) {
      case 'pending' : 
         $SQL = "SELECT SQL_CALC_FOUND_ROWS * FROM $MYSQL_TABLE WHERE COMPLETED = 'No' ORDER BY $MYSQL_ORDERFIELD $LIMIT";
