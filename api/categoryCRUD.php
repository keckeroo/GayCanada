...
$MYSQL_TABLE         = "cglbrd.CATEGORIES";
$MYSQL_RECORDKEY     = "CategoryID";
$MYSQL_DEFAULT_ORDER = "Category_Name";
...
if ($searchfield && $searchvalue) {
   switch ($searchtype) {
      case 'exact'      : $whereClause = "WHERE $searchfield = '$searchvalue' OR $MYSQL_RECORDKEY = '$searchvalue'";
                          break;
      case 'match'      : $whereClause = "WHERE $searchfield LIKE '%$searchvalue%' OR $MYSQL_RECORDKEY = '$searchvalue'";
                          break;
      case 'beginswith' : $whereClause = "WHERE $searchfield LIKE '$searchvalue%' OR $MYSQL_RECORDKEY = '$searchvalue'";
                          break;
      case 'endswith'   : $whereClause = "WHERE $searchfield LIKE '%$searchvalue' OR $MYSQL_RECORDKEY = '$searchvalue'";
                          break;
   }
}
